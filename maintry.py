...
class Backend(QObject):
    ...
    def clearDetections(self):
        try:
            ...
            print("Saved detection data cleared.")
        except Exception as e:
            print("Clear error:", e)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.backend = Backend(self.data_file)
...
function collectDetections() {
    return markers.map(function(marker) {
        ...
        return {
            id: marker.detectionId,
            name: marker.detectionName || marker.detectionId,
            threat: marker.threat || "High",
...
function saveToBackend() {
    if (backend) {
        backend.saveDetections(JSON.stringify(collectDetections()));
    }
}
...
function addDetection(latlng) {
    ...
    marker.on("dragend", saveToBackend);
...
function clearAll() {
    ...
    if (backend) backend.clearDetections();
}
